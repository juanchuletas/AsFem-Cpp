#include "fixed_points_mixed_vr_matrices.hpp"

double *getFixedPointsMixVrMatrices(double *x,double *v, int order,int z) {
         ...
         case 2:
             {
                ...
                if(x0==0.f)
                {
                    ...
                    matV[2] = 0.0;
                    matV[3] = 0.0;
                    matV[4] = z*(-0.16666666666666666*pow(x2,4)/(pow(x1,2)*pow(x1 - x2,2)));
                    matV[5] = z*(((2*x1 - x2)*pow(x2,2))/(6.*x1*pow(x1 - x2,2)));
                    matV[6] = 0.0;
                    matV[7] = z*(((2*x1 - x2)*pow(x2,2))/(6.*x1*pow(x1 - x2,2)));
                    matV[8] = z*((-6*pow(x1,2) + 8*x1*x2 - 3*pow(x2,2))/(6.*pow(x1 - x2,2)));
         ...
         case 3:
             {       
                ...
                if(x0==0.f)
                {
                    ...
                    matV[13] = matV[7];
                    matV[14] = matV[11];
                    matV[15] = ((pow(x3,2)*(-15*pow(x2,2) + 24*x2*x3 - 10*pow(x3,2)) - 5*pow(x1,2)*(6*pow(x2,2) - 8*x2*x3 + 3*pow(x3,2)) + 4*x1*x3*(10*pow(x2,2) - 15*x2*x3 + 6*pow(x3,2)))*z)/(30.*pow(x1 - x3,2)*pow(x2 - x3,2));
                }
                else
                {
