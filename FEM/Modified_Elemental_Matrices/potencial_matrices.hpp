...
double *getPotentialElementalMatrices(double *x,double *v, int order,int z) {
	     ...
	     case 2:
		     {
		     	...
		     	if(x0==0.f)
		     	{
			        matV[0] = 0.0; matV[1] = 0.0;
                    matV[2] = 0.0; matV[3] = 0.0;
                    matV[4] = -0.16666666666666666*pow(x2,4)/(pow(x1,2)*pow(x1 - x2,2)); matV[5] = ((2*x1 - x2)*pow(x2,2))/(6.*x1*pow(x1 - x2,2));
                    matV[6] = 0.0; matV[7] = ((2*x1 - x2)*pow(x2,2))/(6.*x1*pow(x1 - x2,2));
                    matV[8] = (-6*pow(x1,2) + 8*x1*x2 - 3*pow(x2,2))/(6.*pow(x1 - x2,2));
				}
		     	else
		     	{ 
	     ...
	     case 3:
             {       
		     	...
		     	if(x0==0.f)
				{
					...
					matV[3] = 0.0;
					matV[4] = 0.0;
					matV[5] = -0.03333333333333333*(pow(x3,4)*(5*pow(x2,2) - 4*x2*x3 + pow(x3,2))*z)/(pow(x1,2)*pow(x1 - x2,2)*pow(x1 - x3,2));
					matV[6] = (pow(x3,4)*(5*x1*x2 - 2*x1*x3 - 2*x2*x3 + pow(x3,2))*z)/(30.*x1*pow(x1 - x2,2)*x2*(x1 - x3)*(x2 - x3));
					matV[7] = (pow(x3,2)*(x1*(-10*pow(x2,2) + 10*x2*x3 - 3*pow(x3,2)) + x3*(5*pow(x2,2) - 6*x2*x3 + 
				               2*pow(x3,2)))*z)/(30.*x1*(x1 - x2)*pow(x1 - x3,2)*(x2 - x3));
					matV[8] = matV[2];
					matV[9] = (pow(x3,4)*(5*x1*x2 - 2*x1*x3 - 2*x2*x3 + pow(x3,2))*z)/(30.*x1*pow(x1 - x2,2)*x2*(x1 - x3)*(x2 - x3));
					matV[10] = -0.03333333333333333*(pow(x3,4)*(5*pow(x1,2) - 4*x1*x3 + pow(x3,2))*z)/(pow(x1 - x2,2)*pow(x2,2)*pow(x2 - x3,2));
					matV[11] = (pow(x3,2)*(2*x1*(5*x2 - 3*x3)*x3 + 5*pow(x1,2)*(-2*x2 + x3) + pow(x3,2)*(-3*x2 + 2*x3))*z)/(30.*x2*(-x1 + x2)*(x1 - x3)*pow(x2 - x3,2));
					matV[12] = 0.0;
					matV[13] = matV[7];
		            matV[14] = matV[11];
					matV[15] = ((pow(x3,2)*(-15*pow(x2,2) + 24*x2*x3 - 10*pow(x3,2)) - 5*pow(x1,2)*(6*pow(x2,2) - 8*x2*x3 + 3*pow(x3,2)) + 
							    4*x1*x3*(10*pow(x2,2) - 15*x2*x3 + 6*pow(x3,2)))*z)/(30.*pow(x1 - x3,2)*pow(x2 - x3,2));
